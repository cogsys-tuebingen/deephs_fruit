...
from classification.models.se_net import SE_Block


class SEClassifierNetwork(nn.Module):
    def __init__(self, bands, num_classes=3, hidden_layers=[25, 30, 50]):
        super(SEClassifierNetwork, self).__init__()
        self.bands = bands
        kernel_count = 3
