...
import ablation_study.conv.our_model_conv as our_model_conv
...
def get_model(hparams):
    ...
    if hparams['model'] == 'ours':
        if hparams['conv'] == 'depth':
            model = ClassifierNetwork(bands)
        elif hparams['conv'] == 'normal':
...
def get_args():
    ...
    parser.add_argument("--conv", default="depth", type=str)
