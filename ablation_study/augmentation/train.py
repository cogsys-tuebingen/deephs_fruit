...
def get_args():
    ...
    parser.add_argument("--augmentation_variant", default="best", type=str)
...
if __name__ == "__main__":
    ...
    if hparams['augmentation_variant'] == 'best':
        pass
    elif hparams['augmentation_variant'] == 'no_test':
        hparams['test_augmentation'] = False
    elif hparams['augmentation_variant'] == 'no_noise':
        hparams['augmentation_config']['random_noise'] = False
    elif hparams['augmentation_variant'] == 'no_cut':
        hparams['augmentation_config']['random_cut'] = False
    elif hparams['augmentation_variant'] == 'no_augmentation':
        hparams['test_augmentation'] = False
        hparams['augmentation_config']['random_cut'] = False
        hparams['augmentation_config']['random_noise'] = False
        hparams['augmentation_config']['random_rotate'] = False
        hparams['augmentation_config']['random_flip'] = False
    elif hparams['augmentation_variant'] == 'no_transform':
        hparams['augmentation_config']['random_rotate'] = False
        hparams['augmentation_config']['random_flip'] = False
    else:
